						...
						<div class="auth-box2">
							...
							<div class="panel">
								...
								<div class="panel-body">
									...
									<label>Konum</label>
									<input type="text" class="form-control input-md" placeholder="konumu yazınız" name="konum">
									<br>
									<label>Email</label>
									<input type="email" class="form-control input-md" placeholder="email yazınız" name="email">
									<br>
									<label>Açıklama</label>
									<textarea class="form-control input-md" rows="6" name="aciklama"></textarea>
									<br>
									...
									$sql="insert into iletisim (konum,email,aciklama) values ('$konum','$email','$aciklama')";
