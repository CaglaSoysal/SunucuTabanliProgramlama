	...
	<div id="wrapper">
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title">Özgeçmiş</h3>
					<div class="row">
						<div class="col-md-6">
							<!-- INPUTS -->
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title"><b>Eğitim Alanı</b><br>Alanları doldurunuz.</h3>
								</div>
								<div class="panel-body">
								<form action="<?=$_SERVER['PHP_SELF']?>" method="post">
									<label>Öğretim Kurumunun Adı</label>
									<input type="text" class="form-control input-md" placeholder="adını yazınız" name="eadi">
									<br>
									<label>Yılı / Yılları</label>
									<input type="text" class="form-control input-md" placeholder="yılı yazınız" name="eyili">
									<br>
									<label>Bölüm</label>
									<input type="text" class="form-control input-md" placeholder="bölümü yazınız" name="ebolum">
									<br>
									<label>Açıklama</label>
									<input type="text" class="form-control input-md" placeholder="açıklama yazınız" name="eaciklama">
									<br>
									<button type="submit" class="btn btn-primary" name="form1"><i class="fa fa-refresh"></i> Ekle</button>
								</form>
								<?php
								if (isset($_POST['form1']))
									...
									$eyili =  $_POST['eyili'];
									$ebolum = $_POST['ebolum'];
									$eaciklama = $_POST['eaciklama'];
									if($eadi=="" || $eyili==""|| $ebolum=="" || $eaciklama=="" )
									{
									...
									$sql="insert into egitim (universite,tarih,bolum,aciklama) values ('$eadi','$eyili','$ebolum','$eaciklama')";
						...
						<div class="col-md-6">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title"><b>Staj Alanı</b><br>Alanları doldurunuz.</h3>
								</div>
								<div class="panel-body">
									<form action="<?=$_SERVER['PHP_SELF']?>" method="post">
								    <label>Firma  Adı</label>
								    <input type="text" class="form-control input-md" placeholder="adını yazınız" name="sadi">
									<br>
									<label>Yılı / Yılları</label>
									<input type="text" class="form-control input-md" placeholder="yılı yazınız" name="syili">
									<br>
									<label>Açıklama</label>
									<input type="text" class="form-control input-md" placeholder="açıklama yazınız" name="saciklama">
									<br>
									<button type="submit" class="btn btn-primary" name="form2"><i class="fa fa-refresh"></i> Ekle</button>
									</form>
									<?php
								if(isset($_POST['form2']))
									...
									$sql="insert into staj (firmaAdi,tarih,aciklama) values ('$sadi','$syili','$saciklama')";
									$sonuc=mysqli_query($baglanti,$sql);
