	...
	<div id="wrapper">
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title">Referanslar</h3>
					<div class="row">
						<div class="auth-box2">
							<!-- INPUTS -->
							<div class="panel">
								...
								<div class="panel-body">
									...
									<input type="text" class="form-control input-md" placeholder="metni yazınız" name="adi">
									<br>
									<label>Link</label>
									<input type="text" class="form-control input-md" placeholder="linki yazınız" name="link">
									<br>
									<label>Filtre</label>
								...
								if ($_SERVER['REQUEST_METHOD']=="POST")
									...
									$sql="insert into referanslar (resim,adi,link,filtre) values ('$resim','$adi','$link','$filtre')";
