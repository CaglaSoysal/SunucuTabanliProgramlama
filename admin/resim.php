	...
	<div id="wrapper">
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title">Giriş Resmi ve Yazısı</h3>
					<div class="row">
						<div class="auth-box2">
							<!-- INPUTS -->
							<div class="panel">
								...
								<div class="panel-body">
									...
									<input type="text" class="form-control input-md" placeholder="metni yazınız" name="ametin">
									<br>
									<label>Diğer Metin</label>
									<input type="text" class="form-control input-md" placeholder="metni yazınız" name="dmetin">
									<br>
									...
									$sql="insert into girisresmi (resim,buyukYazi,kucukYazi) values ('$resim','$ametin','$dmetin')";
