...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="index.html">ÇAĞLA SOYSAL</a>
			</div>
			<div class="container-fluid">
				...
				<div id="navbar-menu">
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="lnr lnr-user"></i><span>Samuel</span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
							<ul class="dropdown-menu">
								<li><a href="#"><i class="lnr lnr-exit"></i> <span>Çıkış yap</span></a></li>
							</ul>
						</li>
					</ul>
				</div>
						...
						<div class="col-md-12">
									...
									if($_SERVER['REQUEST_METHOD']=="GET"){
										...
										if($sonuc>0){
											...
											"Mesaj başarıyla silindi.<br><br><a href='mesajlar.php' class='alert-link'>Geriye git</a>.".
										"</div>";
										}
										else{ 
											echo" <div class='alert alert-danger' role='alert'>".
											"Mesaj silinirken bir hata oluştu.<br><br><a href='mesajlar.php' class='alert-link'>Geriye git</a>.".
										"</div>";
									        } 
									    } 
									?>
